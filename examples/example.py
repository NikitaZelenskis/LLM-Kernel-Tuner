...
if __name__ == "__main__":
    ...
    kernel_transformer = LLMKernelTransformer(
        kernel_string, 
        model, 
        clang_args=['-resource-dir', '/usr/lib/clang/18']
    )
    ...
    # The performance overview is already displayed during tuning,
    # but you can access the performance tracker for additional analysis
    print(f"\nTotal optimization steps: {len(performance_tracker.steps)}")
